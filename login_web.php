...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<form class="col s12" action="conexion_login.php" method="POST">
					<div class="col s12 m12">
						<div class="card-panel #448aff blue accent-2" id="registro">
							<h2 class="center-align white-text">DoTask - Login</h2>
						</div>
					</div>
					<div class="row">
					...
					<center>
						<a href="registro_web.php" id="reg">¿No estás registrado?</a>
					</center>
