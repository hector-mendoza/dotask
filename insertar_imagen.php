			...
			<div class="container">				
				...
				<div class="card-panel blue hoverable col m12" id="descrip">
						<span class="white-text">
							<h4 class="center-align"><b>Agrega una IMAGEN</b></h4>
						</span>
						<p class="white-text center-align">muy FÁCIL y RÁPIDO</p>
					</div>
				</div>

				<form class="form-horizontal" action="insertarImagen.php" method="POST" enctype="multipart/form-data">
				
					<div class="form-group">
						<label for="titulo" class="control-label col-md-2 blue-text"><h5>Titulo:</h5></label>
						<div class="col-md-10">
							<input type="text" name="titulo" class="form-control" id="titulo" placeholder="Inserta el título de la imagen..." autofocus required>
						</div>
					</div>

					<div class="form-group">
						<label for="Imagen" class="control-label col-md-2 blue-text"><h5>Imagen:</h5></label>
						<div class="col 10">
							<input type="file" name="imagen" id="imagen" class="form-control" id="descrip">
						</div>
					</div>
				</div>
				<center>				
