<?php
	...
	mysql_query("INSERT INTO notas_archivadas VALUES('$_GET[id]','$_SESSION[id_usuario]','$_GET[tit]','$_GET[des]')",$link) or die('<h2>Error al eliminar</h2><br><br><a href="index.php"><h1>Regresar</h1></a>');

	mysql_query("DELETE FROM notas WHERE id_nota = '$_GET[id]'");
 ?>
 	<script type="text/javascript" charset="utf-8">
		alert('NOTA ARCHIVADA :D');
        location.href = "notas_archivo.php";
	</script>